...
class Service extends Model
{
    ...
    {
        $data = (new ServiceSchema())->filter($rdata);

        $qry = 'INSERT INTO `' . $this->db->prefixTable('services') . '`(`title`, `slug`, `cid`, `image`, `video`, `info`, `mdesc`, `mkeywords`, `status`, `date_added`)
                VALUES ('
    ...
    {
        $qry = 'UPDATE `' . $this->db->prefixTable('services') . '`
