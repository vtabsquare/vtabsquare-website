...
// blogs
$routes->get('blogs/([a-zA-Z0-9\-]+)', 'Blogs\Category::index/$1');
$routes->get('api/blogs/([a-zA-Z0-9\-]+)/pagination', 'Blogs\Category::api/getPagination/$1');

$routes->get('blogs', 'Blogs\Home::index');
$routes->get('api/blogs/pagination', 'Blogs\Home::api/getPagination');

$routes->get('blog/([a-zA-Z0-9\-]+)', 'Blogs\Item::index/$1');

// photos
$routes->get('photos/([a-zA-Z0-9\-]+)', 'Photos\Category::index/$1');
$routes->get('api/photos/([a-zA-Z0-9\-]+)/pagination', 'Photos\Category::api/getPagination/$1');
...
$routes->get('service/([a-zA-Z0-9\-]+)', 'Services\Item::index/$1');

// technologies
$routes->get('technologies/([a-zA-Z0-9\-]+)', 'Technologies\Category::index/$1');
$routes->get('api/technologies/([a-zA-Z0-9\-]+)/pagination', 'Technologies\Category::api/getPagination/$1');
...
$routes->get('technology/([a-zA-Z0-9\-]+)', 'Technologies\Item::index/$1');

// case studies
$routes->get('case-studies', 'Casestudy\Home::index');

$routes->get('case-studies/([a-zA-Z0-9\-]+)', 'Casestudy\Item::index/$1');
