...
use App\Data\Technologies\Categories\FilterConfig;
...
class Home extends Controller
{
    ...
    protected function index(): void
    {
        ...
        echo view('app/admin/technologies/categories/home', $data);
    }
    ...
    protected function getItems(): void
    {
        ...
        $content = view(
            'app/admin/technologies/categories/categories_content',
            $data
        );
