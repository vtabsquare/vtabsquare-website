    ...
    <title>Case Studies - <?= config('Config\App')->siteTitle ?></title>
    <!-- meta for search engines -->
    <?php if ($pagePrev): ?>
    <link rel="prev" href="<?= config('Config\App')->baseURL ?>case-studies?page=<?= $currentPage - 1 ?>">
    <?php endif; ?>

    <?php if ($pageNext): ?>
    <link rel="next" href="<?= config('Config\App')->baseURL ?>case-studies?page=<?= $currentPage + 1 ?>">
    <?php endif; ?>
    ...
    <?= view('app/default/common/menu', ['pageName' => 'Case Studies']) ?>
    ...
    <div class="container pb-4">
        <div class="row">
            <div class="col-md-12">
                <nav class="j-pagination" data-url="casestudy/pagination?page=<?= $currentPage ?>">
                    <ul class="pagination justify-content-between">
                        <li class="page-item">
                            <?php if ($pagePrev): ?>
                            <a class="page-link" href="case-studies?page=<?= $currentPage - 1 ?>">
