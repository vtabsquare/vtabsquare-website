    ...
    <meta property="og:url" content="<?= config('Config\App')->baseURL ?>technology/<?= hentities($technology['slug']) ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "<?= config('Config\App')->baseURL ?>technology/<?= hentities($technology['slug']) ?>"
        },
