                ...
                <div class="col-xxl-6 col-lg-7 text-center text-lg-start">
                    <div class="ps-xl-5">
                        <div class="title-area mb-37">
                            <span class="sub-title"><span class="text">About VTAB Square, Empowering Digital Innovation</span></span>
                            <h2 class="sec-title">Empowering Businesses Through Innovation & Excellence</h2>
                            <p class="sec-description">Learn about VtabSquare’s mission, values, and commitment to helping organizations thrive through technology and innovation.</p>
                            <p class="sec-keywords">about VtabSquare, our story, company values, digital innovation, IT company, software development firm, tech consulting</p>
