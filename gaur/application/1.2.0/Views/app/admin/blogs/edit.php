    ...
    <title>Edit a blog - <?= config('Config\App')->siteName ?></title>
    ...
    <main class="container" id="j-ar">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" data-url="admin/blogs/<?= $blog['id'] ?>" data-timeout="3000">
                    <div class="form-row">
                        <div class="col-md-4 form-group">
                            <label>Title <span class="text-danger">*</span></label>
                            <input class="form-control" name="title" type="text" required value="<?= hentities($blog['title']) ?>">
                        </div>

                        <div class="form-group col-md-4">
                            <label>URL <span class="text-danger">*</span></label>
                            <input class="form-control" name="slug" type="text" value="<?= hentities($blog['slug'] ?? '') ?>">
                        </div>

                        <div class="col-md-4 form-group">
                            <label>Category <span class="text-danger">*</span></label>
                            <select class="form-control j-category" name="cid" data-value="<?= $blog['cid'] ?>" data-url="admin/blogs/categories/all">
                    ...
                    <div class="form-row align-items-end">
                        ...
                        <div class="col-md-6 form-group">
                            <?php if ($blog['video']): ?>
                            <div class="text-center mb-2">
                                <div class="img-overlay img-hoverlay cursor-pointer" data-lity data-lity-target="https://www.youtube.com/watch?v=<?= hentities($blog['video']) ?>">
                                    <img class="img-fluid" src="https://i.ytimg.com/vi/<?= hentities($blog['video']) ?>/mqdefault.jpg" alt>
                            ...
                            <label>Video</label>
                            <input class="form-control" name="video" type="text"<?php if ($blog['video']): ?> value="https://www.youtube.com/watch?v=<?= hentities($blog['video']) ?>"<?php endif; ?>>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 form-group">
                            ...
                            <textarea class="form-control" name="mdesc"><?= hentities($blog['mdesc']) ?></textarea>
                        </div>

                        <div class="col-md-6 form-group">
                            <label>Meta keywords</label>
                            <textarea class="form-control" name="mkeywords"><?= hentities($blog['mkeywords']) ?></textarea>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Description</label>
                        <textarea class="form-control j-editor" name="info" rows="10" data-image="blogs" data-size="10MB" data-types="jpeg,jpg,png"><?= hentities($blog['info']) ?></textarea>
                    </div>

                    <div class="form-group">
                        <input name="<?= $csrf['name'] ?>" type="hidden" value="<?= $csrf['hash'] ?>">
                        <input class="btn btn-primary" type="submit" value="Update">
                        <a class="btn btn-secondary" href="admin/blogs">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
