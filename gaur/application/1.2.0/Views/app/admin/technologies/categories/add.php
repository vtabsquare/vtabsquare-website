    ...
    <title>Add a category - <?= config('Config\App')->siteName ?></title>
    ...
    <main class="container" id="j-ar">
        <div class="row">
            <div class="col-md-5">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="admin/technologies/categories">Categories</a>
                    </li>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-9 col-md-7 col-lg-5">
                ...
                <form method="post" data-url="admin/technologies/categories" data-timeout="3000">
                    ...
                    <div class="form-group">
                        <label>Parent</label>
                        <select class="form-control j-category" name="pid" data-url="admin/technologies/categories/all">
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="col">
                            <a class="btn btn-block btn-secondary" href="admin/technologies/categories">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
