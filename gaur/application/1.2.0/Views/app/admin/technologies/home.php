    ...
    <title>Technologies - <?= config('Config\App')->siteName ?></title>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mb-2">
                <div class="form-row row-cols-2 row-cols-sm-3 row-cols-lg-4 justify-content-sm-end">
                    <div class="col mb-2">
                        <a href="admin/technologies/categories" class="btn btn-block btn-success">
                            <span class="fas fa-tags"></span>
                            Categories
                        </a>
                    </div>
                    <div class="col mb-2">
                        <a href="admin/technologies/add" class="btn btn-block btn-primary">
        ...
        <div class="table-responsive">
            <div class="g-table table table-bordered text-center">
                <div class="g-colgroup">
                    ...
                    <div class="g-col g-w-250"></div>
                    <div class="g-col g-w-150"></div>
                ...
                <div class="g-thead bg-light">
                    <div class="g-tr" data-jitem="order">
                        ...
                        <div class="g-th text-left">Title</div>
                        <div class="g-th text-left">Category</div>
                        <div class="g-th">Status</div>
    ...
    <?= view('app/admin/common/js/app', [ 'pageUrl' => 'admin/technologies' ]) ?>
