    ...
    <title>Edit a technology - <?= config('Config\App')->siteName ?></title>
    ...
    <main class="container" id="j-ar">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" data-url="admin/technologies/<?= $technology['id'] ?>" data-timeout="3000">
                    <div class="form-row">
                        <div class="col-md-4 form-group">
                            <label>Title <span class="text-danger">*</span></label>
                            <input class="form-control" name="title" type="text" required value="<?= hentities($technology['title']) ?>">
                        </div>

                        <div class="form-group col-md-4">
                            <label>URL <span class="text-danger">*</span></label>
                            <input class="form-control" name="slug" type="text" value="<?= hentities($technology['slug'] ?? '') ?>">
                        </div>

                        <div class="col-md-4 form-group">
                            <label>Category <span class="text-danger">*</span></label>
                            <select class="form-control j-category" name="cid" data-value="<?= $technology['cid'] ?>" data-url="admin/technologies/categories/all">
                    ...
                    <div class="form-row align-items-end">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="text-center mb-2">
                                <div class="img-overlay img-hoverlay cursor-pointer" data-lity data-lity-target="https://www.youtube.com/watch?v=<?= hentities($technology['video']) ?>">
                                    <img class="img-fluid" src="https://i.ytimg.com/vi/<?= hentities($technology['video']) ?>/mqdefault.jpg" alt>
                            ...
                            <label>Video</label>
                            <input class="form-control" name="video" type="text"<?php if ($technology['video']): ?> value="https://www.youtube.com/watch?v=<?= hentities($technology['video']) ?>"<?php endif; ?>>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 form-group">
                            ...
                            <textarea class="form-control" name="mdesc"><?= hentities($technology['mdesc']) ?></textarea>
                        </div>

                        <div class="col-md-6 form-group">
                            <label>Meta keywords</label>
                            <textarea class="form-control" name="mkeywords"><?= hentities($technology['mkeywords']) ?></textarea>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Description</label>
                        <textarea class="form-control j-editor" name="info" rows="10" data-image="technologies" data-size="10MB" data-types="jpeg,jpg,png"><?= hentities($technology['info']) ?></textarea>
                    </div>
