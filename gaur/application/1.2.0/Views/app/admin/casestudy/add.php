    ...
    <title>Add a case study - <?= config('Config\App')->siteName ?></title>
    ...
    <main class="container" id="j-ar">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" data-url="admin/casestudies" data-timeout="3000">
                    <div class="form-row">
                        ...
                        <!-- <div class="col-md-4 form-group">
                            ...
                            <select class="form-control j-category" name="cid" data-url="admin/services/categories/all">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control j-editor" name="info" rows="10" data-image="casestudy" data-size="10MB" data-types="jpeg,jpg,png"></textarea>
                    </div>
