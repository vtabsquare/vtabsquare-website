    ...
    <title>Add a service - <?= config('Config\App')->siteName ?></title>
    ...
    <main class="container" id="j-ar">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" data-url="admin/services" data-timeout="3000">
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control j-editor" name="info" rows="10" data-image="services" data-size="10MB" data-types="jpeg,jpg,png"></textarea>
                    </div>
