    ...
    <link rel="canonical" href="<?= config('Config\App')->baseURL ?>technologies/item/<?= $technology['id'] ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <a data-lity href="images/technologies/<?= $technology['image'] ?>">
                    <img class="img-fluid d-block mx-auto mb-3" src="images/technologies/<?= $technology['image'] ?>" alt="" style="max-width: 600px" />
                </a>
                <?php endif; ?>

                <?php if ($technology['video']): ?>
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/<?= $technology['video'] ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <br>
                <?php endif; ?>
