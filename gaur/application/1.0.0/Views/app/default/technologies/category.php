    ...
    <?php if ($pagePrev): ?>
    <link rel="prev" href="<?= config('Config\App')->baseURL ?>technologies/category/<?= $category['id'] ?>?page=<?= $currentPage - 1 ?>">
    <?php endif; ?>

    <?php if ($pageNext): ?>
    <link rel="next" href="<?= config('Config\App')->baseURL ?>technologies/category/<?= $category['id'] ?>?page=<?= $currentPage + 1 ?>">
    <?php endif; ?>
    ...
    <div class="container pb-4">
        <div class="row">
            <div class="col-md-12">
                <nav class="j-pagination" data-url="technologies/category/<?= $category['id'] ?>/pagination?page=<?= $currentPage ?>">
                    <ul class="pagination justify-content-between">
                        <li class="page-item">
                            <?php if ($pagePrev): ?>
                            <a class="page-link" href="technologies/category/<?= $category['id'] ?>?page=<?= $currentPage - 1 ?>">
