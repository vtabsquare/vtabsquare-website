    ...
    <title>Account activation - <?= config('Config\App')->siteTitle ?></title>
    ...
    <?= view('app/default/common/menu', ['pageName' => 'Account activation']) ?>

    <main class="container" id="j-ar" data-method="post" data-url="account/activate/email/<?= $token ?>">
