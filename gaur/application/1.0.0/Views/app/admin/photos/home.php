    ...
    <title>Photos - <?= config('Config\App')->siteName ?></title>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mb-2">
                <div class="form-row row-cols-2 row-cols-sm-3 row-cols-lg-4 justify-content-sm-end">
                    <div class="col mb-2">
                        <a href="admin/photos/categories" class="btn btn-block btn-success">
                            <span class="fas fa-tags"></span>
                            Categories
                        </a>
                    </div>
                    <div class="col mb-2">
                        <a href="admin/photos/add" class="btn btn-block btn-primary">
    ...
    <?= view('app/admin/common/js/app', [ 'pageUrl' => 'admin/photos' ]) ?>
