...
?>
    ...
    <title>View a service - <?= config('Config\App')->siteName ?></title>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mb-2">
                <div class="form-row row-cols-2 row-cols-sm-3 row-cols-lg-4 justify-content-sm-end">
                    <div class="col mb-2">
                        <a href="admin/services/edit/<?= $service['id'] ?>" class="btn btn-block btn-primary">
                            <span class="fas fa-edit"></span>
                            Edit
                        </a>
                    </div>
                    <div class="col mb-2">
                        <a href="admin/services" class="btn btn-block btn-secondary">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8"><?= hentities($service['title']) ?></div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8"><?= hentities($service['mdesc']) ?></div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-8"><?= hentities($service['mkeywords']) ?></div>
                        </div>
                        <?php endif; ?>

                        <div class="row mb-3">
                            <div class="col-4">Status</div>
                            <div class="col-8"><span class="<?= $status[$service['status']] ?>"></span></div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-4">Date added</div>
                            <div class="col-8"><?= date('d-m-Y h:i a', strtotime($service['date_added'])) ?></div>
                        </div>

                        <?php if ($service['date_modified']): ?>
                        <div class="row mb-3">
                            <div class="col-4">Date modified</div>
                            <div class="col-8"><?= date('d-m-Y h:i a', strtotime($service['date_modified'])) ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <div class="img-overlay img-hoverlay cursor-pointer" data-lity data-lity-target="https://www.youtube.com/watch?v=<?= $service['video'] ?>">
                            <img class="img-fluid" src="https://i.ytimg.com/vi/<?= $service['video'] ?>/mqdefault.jpg" alt>
