    ...
    <main class="container" id="j-ar">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-9 col-md-7 col-lg-5">
                ...
                <form method="post" data-url="admin/services/categories" data-timeout="3000">
                    ...
                    <div class="form-group">
                        <label>Parent</label>
                        <select class="form-control j-category" name="pid" data-url="admin/services/categories/all">
