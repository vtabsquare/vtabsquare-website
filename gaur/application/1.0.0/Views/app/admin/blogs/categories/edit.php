    ...
    <main class="container" id="j-ar">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-9 col-md-7 col-lg-5">
                ...
                <form method="post" data-method="put" data-url="admin/blogs/categories/<?= $category['id'] ?>" data-timeout="3000">
                    ...
                    <div class="form-group">
                        <label>Parent</label>
                        <select class="form-control j-category" name="pid" data-value="<?= $category['pid'] ?: '' ?>" data-url="admin/blogs/categories/all">
