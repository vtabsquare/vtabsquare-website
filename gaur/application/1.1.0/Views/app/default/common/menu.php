    ...
    <div class="ot-menu-wrapper">
        <div class="ot-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href=""><img src="assets/img/logo.png" alt width="100" /></a>
            </div>
            <div class="ot-mobile-menu">
                <ul>
                    ...
                    <li><a href="photos/category/1">White Paper</a></li>
                    ...
                    <div class="col-auto">
                        <div class="header-links2">
                            <ul>
                                ...
                                <li><i class="far fa-envelope"></i><a href="">information@vtabsquare.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
