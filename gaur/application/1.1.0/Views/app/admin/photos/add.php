    ...
    <title>Add a photo - <?= config('Config\App')->siteName ?></title>
    ...
    <main class="container" id="j-ar" data-image-url="admin/photos/files">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" data-url="admin/photos" data-timeout="3000">
                    <div class="form-row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control j-category" name="cid" data-url="admin/photos/categories/all">
                    ...
                    <div class="form-group d-none">
                        ...
                        <textarea class="form-control j-editor" name="info" rows="10" data-image="photos" data-size="10MB" data-types="jpeg,jpg,png"></textarea>
                    </div>
