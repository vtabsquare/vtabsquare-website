    ...
    <title>Categories - <?= config('Config\App')->siteName ?></title>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 mb-2">
                <div class="form-row row-cols-2 row-cols-sm-3 row-cols-lg-4 justify-content-sm-end">
                    <div class="col mb-2">
                        <a href="admin/technologies/categories/add" class="btn btn-block btn-primary">
            ...
            <div class="g-table table table-bordered table-hover text-center">
                ...
                <div class="g-thead bg-light">
                    <div class="g-tr" data-jitem="order">
                        ...
                        <div class="g-th text-left">Parent</div>
    ...
    <?= view('app/admin/common/js/app', [ 'pageUrl' => 'admin/technologies/categories' ]) ?>
